...
const ProactiveModal: React.FC = () => {
  return (
    <div className="relative group">
      {/* Outer glow effect */}
      <div className="absolute -inset-0.5 bg-cyan-500/20 rounded-2xl blur opacity-30 group-hover:opacity-50 transition duration-1000"></div>
      ...
      <div className="relative glass-morphism p-8 w-[420px] max-w-full">
        ...
        <div className="flex items-center justify-end gap-3 mt-8">
          ...
          <button className="px-6 py-2 text-sm font-semibold bg-cyan-500 text-black rounded-lg hover:bg-cyan-400 hover:shadow-[0_0_15px_rgba(6,182,212,0.4)] transition-all">
            Commit
          </button>
        </div>
      </div>
